...
export class RemoveCommand extends BaseCommand {
    ...
    public constructor(player: Player) {
        ...
        this.data = new SlashCommandBuilder().setName("remove").setDescription("Removes song from queue.");
        this.data.addIntegerOption(option =>
            option.setName(RemoveCommand._idOption).setDescription("Id of song to remove from queue.").setRequired(true)
        );
    }
